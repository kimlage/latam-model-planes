#!/usr/bin/env python3
"""Normalise both DEMs onto one 3601x3601 1-arcsec tile format, for SDSC.
...
# tiles covering ~120 km around SDSC
LATS = [-23, -22, -21]        # SW corner latitudes
LONS = [-50, -49, -48, -47]   # SW corner longitudes
