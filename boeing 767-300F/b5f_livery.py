...
# PLANA. As marcas (lockup CARGO, bandeira, matricula, titulo, simbolo do
# ventre) moram em refazer_marcas.py (tag b763f), constantes movidas
# textualmente. Sequencia de reconstrucao (REBUILD.md):
#     b5f_livery.py -> refazer_marcas.py -- b763f
#     (reparar_echarpe b763f e AUDITORIA: a borda dura embarcada fica)
# A cunha vem da regra unica reparar_echarpe.FROTA["b763f"] sobre a ponte da
# malha (kit.secoes_do_casco) — nao mais do zc_rz() emendado em x = 41.0.
import sys as _sys
...
# cauda diz que a borda dura fica (QA-BACKLOG, 2340 texels).
...
_cov = kit.cobertura_echarpe(_re.FROTA["b763f"]["regra"], _crx, _crzc, _crrz,
                             0.0, LUV, W, H, ss=1)
cunha = _cov >= 0.5
tex[cunha] = INDIGO
...
# Lockup LATAM CARGO, bandeira nacional + COLOMBIA, matricula, titulo de tipo
# e o simbolo do ventre moram em refazer_marcas.py (tag b763f, secao "legado
# 767/777"), com estas mesmas constantes e o mesmo rasterizador, citados la.
# Rodar refazer_marcas e o proximo passo obrigatorio (REBUILD.md). O desgaste
# (suja) fica aqui por ser livery plana; refazer_marcas reaplica as mesmas
# caixas sobre a tinta do ventre que ele pinta.
