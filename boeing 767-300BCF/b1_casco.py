"""Etapa 1 — casco do 767-300ER a partir do spec_763f.json.

Roda headless:
/Applications/Blender.app/Contents/MacOS/Blender -b "boeing 767-300F/B763F_LATAM_CARGO.blend" --python "boeing 767-300F/b1_casco.py"
