...
Herdado sem mudanca do -300F: CC-CXE tem os mesmos winglets Aviation
Partners blended, indigo por fora e coral por dentro, conferidos nas fotos de
aproximacao do proprio CC-CXE (as duas faces aparecem em ref_CC-CXE_appr6 e
ref_CC-CXE_appr1).  So precisa rodar se b2_asas.py reescrever a malha das asas;
o .blend ja veio com os materiais atribuidos.

/Applications/Blender.app/Contents/MacOS/Blender -b \
    "boeing 767-300BCF/B763BCF_LATAM_CARGO.blend" \
    --python "boeing 767-300BCF/b9f_winglets.py"
...
"boeing 767-300F"/refs/ref_N536LA_2021.jpg (jounigripen, CC BY 2.0, 2021-05-07), uma vista de
...
Z_TINTA = 1.15        # abaixo disto a transicao fica clara, como na foto
                      # (medido na foto de baixo de N536LA: o coral da face interna
